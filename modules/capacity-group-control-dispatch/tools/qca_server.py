...
SERVER_ROOT = os.environ.get("QCA_ROOT") or MODULE_ROOT
DATA_FILE = os.path.join(SERVER_ROOT, "data", "qca_requests.json")
...
<body>
  <h1>群控群调页面入口</h1>
  <ul>
    <li><a href="/pages/power-bureau-portal.html">供电局端</a></li>
    <li><a href="/pages/operations-portal.html">运营端</a></li>
    <li><a href="/pages/owner-portal.html">业主端</a></li>
  </ul>
