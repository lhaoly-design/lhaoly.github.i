(() => {
  ...
  const sidebarMobile = (active, options = {}) => {
    ...
    const mobileNavHrefMap = {
      车辆信息: withVersion('./车辆信息.html'),
      车辆位置: withVersion('./移动绿电数据面板.html'),
      企业信息建档: withVersion('./项目信息.html'),
      工单管理: withVersion('./工单列表.html'),
      调度管理: withVersion('./调度列表.html'),
      订单管理: withVersion('./订单列表.html'),
      当前告警: withVersion('./告警报警.html'),
      全部告警: withVersion('./告警历史.html')
    };
